...
# Load account
private_key = "0xafacbf3eb41be279cb215934634f7862cf17dc6f311a489bce9ce2f0d85eec5e"  # Replace with Peer 2's private key from Ganache
...
def request_data():
    data_key = "sensor11"  # Key of the data being requested (e.g., temperature from Peer 3)
