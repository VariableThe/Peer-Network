...
# Load account
private_key = "0x49e06a3bf17791c5a713106393ed2ea58527b85bebe19fe372fdaea16ec9937d"  # Replace with Peer 1's private key from Ganache
...
def request_data():
    data_key = "sensor8"  # Key of the data being requested (e.g., pressure from Peer 2)
